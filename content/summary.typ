...
#pagebreak()
= Summary <summary>
This chapter concludes this thesis with the status update regarding the requirements, underlines the contributions, and provides an outlook about possible directions for future work.
